...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // Ensure minimum length is at least 1 to avoid invalid quantifier in regex
        int min = Math.max(minLength, 1);
        String regex = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d).{" + min + ",}$";
    ...
    public static List<String> extractEmails(String str) {
        ...
        // At least one character before '@', ending with @mail.utoronto.ca or @utoronto.ca
